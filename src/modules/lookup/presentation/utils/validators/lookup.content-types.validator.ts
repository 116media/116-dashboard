...
/**
 * Validation rules for content type create/edit forms.
 *
 * @description
...
export const ContentTypesValidator = {
    /**
     * Validates content type name field.
     *
     ...
     */
    name: (label: string): Rule[] => [ValidatorUtils.required(label), ValidatorUtils.max(label, 50)]
} as const;
